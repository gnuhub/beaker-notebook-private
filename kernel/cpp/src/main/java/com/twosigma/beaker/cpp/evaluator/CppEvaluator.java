...
*/
package com.twosigma.beaker.cpp.evaluator;
...
public class CppEvaluator implements Evaluator {
  ...
  protected class jobDescriptor {
    ...
    jobDescriptor(SimpleEvaluationObject o, String c) {
      outputObject = o;
      codeToBeExecuted = c;
    }
  ...
  public void evaluate(SimpleEvaluationObject seo, String code) {
    // send job to thread
    jobQueue.add(new jobDescriptor(seo, code));
    syncObject.release();
  }
  ...
  protected class workerThread extends Thread {
    ...
    public void run() {
      ...
      while (!exit) {
        try {
          ...
          if (!executor.executeTask(new MyRunnable(j.outputObject, code, true))) {
    ...
    protected class MyRunnable implements Runnable {
      ...
      public MyRunnable(SimpleEvaluationObject out, String code, boolean ro) {
        theOutput = out;
        theCode = code;
        retObject = ro;
      }
      ...
      private String createMainCaller(String type) {
        ...
        if (type != "void") {
          ...
          builder.append("\t").append(type).append(" ret;\n");
