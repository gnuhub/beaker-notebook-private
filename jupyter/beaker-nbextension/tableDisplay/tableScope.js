define([
  ...
  'nbextensions/beaker/tableDisplay/consts'
], function(
  dataTables,
  ...
  TableScope.prototype.doUsePagination = function() {
    ...
    if(!self.pagination.use){
      ...
      console.log('set rowsToDisplay', self.pagination.rowsToDisplay);
    }
    // reorder the table data
    self.applyChanges();
  ...
  TableScope.prototype.buildTemplate = function() {
    ...
    var tmpl = buildTemplate(self.id);

    self.element = $('div#'+self.wrapperId);
