...
import static com.twosigma.beaker.widgets.TestWidgetUtils.verifyOpenCommMsgBeakerWidgets;
...
public class TableDisplayTest {
  ...
  public void shouldSendCommOpenWhenCreate() throws Exception {
    ...
    //then
    verifyOpenCommMsgBeakerWidgets(groovyKernel.getMessages(), TableDisplay.MODEL_NAME_VALUE, TableDisplay.VIEW_NAME_VALUE);
  }
