...
public class CombinedPlot extends com.twosigma.beaker.chart.xychart.CombinedPlot implements CommFunctionality, InternalWidget, InternalPlot {

  private Comm comm;

  public CombinedPlot() throws NoSuchAlgorithmException {
