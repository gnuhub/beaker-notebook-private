...
public class PlotObjectSerializer extends BasicObjectSerializer {
  ...
  public boolean writeObject(Object obj, JsonGenerator jgen, boolean expand)
      ...
      } else if (expand && obj instanceof HistogramBase) {
        jgen.writeObject((HistogramBase) obj);
      ...
      } else if (expand && obj instanceof CombinedPlotBase) {
        jgen.writeObject((CombinedPlotBase) obj);
      }else if (expand && obj instanceof HeatMapBase) {
        jgen.writeObject((HeatMapBase) obj);
      } else {
        return false;
      }
    return true;
